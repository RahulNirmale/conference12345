...
public class ConferenceApi {
	 ...
	 */
	  ...
	  // TODO (Lesson 4) 
	  // Allocate a key for the conference -- let App Engineallocate the ID
	  ...
	  // as the parent of the conference
       ...
       //Conference conference = new Conference(conferenceId, displayName, displayName, profileKey, displayName, null, displayName, null, null, 0, 0, 0);
	    ...
	    public WrappedBoolean unregisterFromConference(final User user,
	        ...
	        WrappedBoolean result = ofy().transact(new Work<WrappedBoolean>() {
	            ...
	            public WrappedBoolean run() {
	                ...
	                Profile profile = getProfileFromUser(user, websafeConferenceKey);
	 ...
	 /**
	  ...
	  public List<Conference> getConferencesCreated(final User user)throws UnauthorizedException {
		  ...
		  Query<Conference> query=ofy().load().type(Conference.class).ancestor(userKey).order("name");
